        ...
        match key:
            ...
            case "LINK":
                if isfile(sym_link):
                    ...
                    self.message += (
                        f"Symlink <{sym_link}> does not exists, it will be created!"
                    )
            ...
            case "LINKING":
                logger.warning(
                    f"{self.message}Symlink <{sym_link}> does not point to file <{src_file}>, symlink will be overwritten."
                )
